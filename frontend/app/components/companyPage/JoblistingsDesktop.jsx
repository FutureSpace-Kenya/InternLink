          ...
          <tbody>
            ...
            {pageData2.map((listing, index) => (
              <tr key={index} className="cursor-pointer hover:bg-slate-200">
                ...
                <td>
                  <span className="text-sm">{listing.requirements}</span>
                </td>
                <td>
                ...
                <td>
                  <div className="flex justify-between items-center">
                    <span className="text-xs">{listing.deadline}</span>
                    {valid_to_display && (
...
JoblistingsDesktop.propTypes = {
  valid_to_display: PropTypes.bool.isRequired,
  durations: PropTypes.arrayOf(PropTypes.string).isRequired,
  setJobListingsFilter: PropTypes.func.isRequired,
  pageData2: PropTypes.object.isRequired,
  jobListings: PropTypes.array.isRequired,
  currentPageJL: PropTypes.number.isRequired,
  setCurrentPageJL: PropTypes.func.isRequired,
};
