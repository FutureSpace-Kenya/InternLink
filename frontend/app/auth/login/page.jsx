...
export default function Login() {
  ...
  const logout = async () => {
    const token = session?.token?.token?.token?.user?.access;

    // Make an API call to your logout URL
          ...
          <div className="w-full flex justify-center items-center flex-col mt-8">
            ...
            <div className="flex mt-4 flex-col sm:flex-row w-9/12 gap-3 items-center justify-between">
              <div className="w-full">
                <button
                  className={
                    "btn btn-outline text-red-600 ring-2  ring-offset-1 w-full"
                  }
                  onClick={logout}
                >
              ...
              <Link className={"w-full"} href={"/intern/dashboard"}>
                <button
                  className={
                    "btn btn-outline btn-secondary ring-2  ring-offset-1 w-full"
                  }
                >
        ...
        <div className="w-full mt-8">
          <form className="shadow-sm p-6 rounded" onSubmit={handleSubmit}>
            ...
            <div className="flex text-[12px] underline underline-offset-2 gap-3">
              ...
              <Link
                className={
                  "inline-block align-baseline my-2 text-blue-500 hover:text-blue-800"
                }
                href={"/auth/register"}
              >
                New User? Sign Up
