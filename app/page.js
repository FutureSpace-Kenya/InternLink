  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
        <div className="flex relative flex-col items-center">
            <div class="w-fit relative flex flex-col items-center">
                <h1 className="text-6xl font-bold">InternLink</h1>
                <div class="absolute top-[55px] right-0 mb-4 text-xs font-medium text-orange-800">
        ...
        <div className="flex space-x-4 mt-8">
            ...
            <button className="btn btn-outline btn-secondary ring-1 ring-secondary ring-offset-1">
