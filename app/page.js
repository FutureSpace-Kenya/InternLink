    ...
    return (
        <>
            ...
            <div className="flex flex-col sm:flex-row h-96 items-center justify-center w-full">
                ...
                <div className="left flex gap-10 w-full p-4 sm:w-1/2">
                    ...
                    <div className="right flex flex-col gap-10">
                        <div className="custom-c relative">
                            <div
                                ...
                                <i className="fa-solid text-3xl text-white fa-shield-halved"></i>
                            </div>
                            <svg className="w-24 top-6 absolute h-24">
                                ...
                                <circle cx="50%" cy="50%" r="40%" stroke="url(#gradientStroke)" strokeWidth="4"
                                        fill="transparent"/>
                            </svg>
                    ...
                    <div className="right -mt-14 flex flex-col gap-10">
                        <div className="custom-c relative">
                            <div
                                className="cicle grid place-items-center  from-green-700 to-transparent rounded-full w-20 h-20">
                                <i className="fa-solid text-3xl text-white fa-shield-halved"></i>
