    ...
    return (
        <>
            ...
            <div className="flex flex-col sm:flex-row h-96 items-center justify-center w-full">
                ...
                <div className="left w-full p-4 sm:w-1/2">
                    ...
                    <div className="custom-c relative">
                        ...
                        <svg className="w-24 top-3 absolute h-24">
                            <defs>
                                <linearGradient id="gradientStroke" x1="0%" y1="100%" x2="0%" y2="0%">
                                    <stop offset="10%" style={{stopColor: "rgb(74, 222, 128,0)", stopOpacity: 0}}/>
                                    <stop offset="70%" style={{stopColor: "rgb(74, 222, 128,0.5)", stopOpacity: 0.5}}/>
                                    <stop offset="100%" style={{stopColor: "rgb(74, 222, 128)", stopOpacity: 1}}/>
                                </linearGradient>
                            </defs>
                            <circle cx="50%" cy="50%" r="40%" stroke="url(#gradientStroke)" strokeWidth="3"
                                    fill="transparent"/>
                        </svg>
