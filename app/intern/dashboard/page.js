      ...
      <nav className="bg-green-500 p-4 flex justify-between items-center text-white">
        ...
        <div className="flex gap-2">
          ...
          <button className="text-white bg-green-700 btn ring-1 ring-gray-100 ring-offset-1 btn-circle btn-ghost btn-sm">
            <i
              className={
                session.user ? "fa-solid fa-user" : "fas fa-sign-in-alt"
              }
            ></i>
          </button>
        </div>
        ...
        <div className="w-full bg-green-100 grid grid-cols-1 place-items-center h-72 gap-6">
          <div className="landing-page">
            <div className="text-center">
              ...
              >
                Find your dream :{" "}
                <span className="text-green-500">internship</span>
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center p-4">
          ...
          <div className="cards gap-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div className="custom-card">
              ...
              <div className="middle">
                <div className="mt-4 px-3 font-medium">
                  FutureSpace Kenya is a software development company that
                  builds enterprise software solutions.
                </div>
            ...
            <div className="custom-card">
              ...
              <div className="middle">
                <div className="mt-4 px-3 font-medium">
                  Learn about our culture, our people, and career opportunities
                  at the Facebook
                </div>
            ...
            <div className="custom-card">
              ...
              <div className="middle">
                <div className="mt-4 px-3 font-medium">
                  Apple is a place where extraordinary people gather to do their
                  best work.
                </div>
